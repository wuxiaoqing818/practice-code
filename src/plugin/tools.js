   ...
   * @description 数组去重
   */
  export const duplicateRemoval = (arr1) => {
    
    return arr1.reduce((prev,cur) => prev.includes(cur) ? prev : [...prev,cur],[]);
  }
  /**
   * @param {Array} arr1
   * @param {key } string
   * @description 判断对象中是否包含这个属性
   */
  export const isObject = (arr1,key) => {
    
    return arr1.hasOwnProperty(key)
  }
  /**
   * @param {Array} arr
   * @param {option } Object
   * @description 判断数组中是否包含某一项
   */
  export const isArray = (arr,option) => {
